...
clean:
	rm -rf .bindep $(BIN_DIR)/openstack-cloud-controller-manager \
                   $(BIN_DIR)/cinder-flex-volume-driver \
                   $(BIN_DIR)/cinder-provisioner \
                   $(BIN_DIR)/cinder-csi-plugin \
                   $(BIN_DIR)/k8s-keystone-auth
